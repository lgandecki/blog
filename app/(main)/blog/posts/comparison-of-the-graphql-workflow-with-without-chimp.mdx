...
export const EchoResponseLength: EchoResponseResolvers["length"] = (parent, args, context) => {
  throw new Error("Not implemented yet");
};
```
...
export const EchoResponseLength: EchoResponseResolvers["length"] = (parent, args, context) => parent.text.length;
```
...
export const resolvers = merge({}, authorResolvers, libraryResolvers, echoResolvers);
```
