---
title: "Better way to use useReducer with TypeScript"
publishedAt: "2021-03-30"
summary: "Introducing useComplexState hook, a small wrapper combining Redux Toolkit, useReducer with some extra syntax sugar to make things even simpler and more to the point."
heroImage: "https://cdn.prod.website-files.com/66d9c8ce74a4739309e271dd/66fffaa441974863e7b322be_jason-leung-Xaanw0s0pMk-unsplash.webp"
---
...
export default function App() {
  ...
  return (
      ...
      {state.count}
       ...
       dispatch({ type: "increment" })}>1 point
...
function App() {
  ...
  return (
      ...
      {state.count}
       dispatch(incrementBy(2)) /* #3 */}>
        2 points!
      
       dispatch(increment()) /* #3 */}>1 point
...
[https://xolv.io/dev-notes/choosing-between-use-state-and-use-reducer](https://xolv.io/dev-notes/choosing-between-use-state-and-use-reducer?ref=xolvio.ghost.io)
