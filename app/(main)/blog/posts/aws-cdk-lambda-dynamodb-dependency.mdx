...
([https://github.com/xolvio/aws-sales-system-example/tree/dependencyManagement](https://github.com/xolvio/aws-sales-system-example/tree/dependencyManagement?ref=xolvio.ghost.io))
